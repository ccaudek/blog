...
$$
\mathbb{E}(y) = \sum_{i=1}^n y \cdot p_i
$$
...
$$
Var(y) = \sum_{i=1}^n (y - \mu)^2 \cdot p_i
$$
...
$$
Var(y) = \mathbb{E}(y^2) - \mathbb{E}(y)^2= \sum_{i=1}^n (y^2 - \mu)^2 \cdot p_i - \Bigg(\sum_{i=1}^n y \cdot p_i\Bigg)
$$
