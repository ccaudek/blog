...
Le curve in tutti i pannelli della figura precedenti sono funzioni di verosimiglianza calcolate utilizzando la legge Binomiale, ma considierando insimi diversi di dati. Nel pannello _n = 1_ ci chiediamo qual è la plausibilità dei possibili valori del parametro sconosciuto _p_ se abbiamo osservato solo un insuccesso in 9 prove. Nel secondo pannello, _n = 2_ ci facciamo la stessa domanda, ma avendo osservato un insuccesso e un successo. E così via.


Iniziamo dal pannello _n = 1_. 

La definizione di funzione di verosimiglianza ci dice che dobbiamo usare la legge Binomiale __tenendo costanti i dati__. Questo significa che __dobbiamo variare__ i valori del parametro _p_. Quali valori può assumere _p_?  Tutti i valori nell'intervallo [0, 1]. Ne considereremo qui 50:
