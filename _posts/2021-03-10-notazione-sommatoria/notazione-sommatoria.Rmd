...
description: |
  Il simbolo $\Sigma$ si chiama sommatoria e denota la somma di un certo numero di addendi.
author:
  - name: Corrado Caudek
...
ciò significa, semplicemente, *somma tutti i valori*. Se sviluppiamo la notazione precedente, per questi dati avremo
...
In `R` una sommatoria si svolge utilizzando la funzione `sum()`.  Quindi, nel caso presente, per i dati del vettore `x`, l'operazione aritmetica
