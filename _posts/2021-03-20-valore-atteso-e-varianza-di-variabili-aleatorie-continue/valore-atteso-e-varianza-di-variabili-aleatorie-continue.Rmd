...
$$
Iniziamo a definire in `R` la funzione composta $x^2$:

```{r}
h <- function(y) y^2 * f(y)
```

Calcoliamo poi l'area sottesa dal grafico di tale funzione. Applicando la formula della varianza otteniamo il risultato desiderato:
