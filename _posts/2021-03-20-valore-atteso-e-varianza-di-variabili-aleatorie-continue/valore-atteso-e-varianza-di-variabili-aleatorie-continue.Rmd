...
Calcoliamo poi l'area sottesa dal grafico di tale funzione (cioè il valore atteso di $y^2$) e applichiamo la formula della varianza (ovvero, sottraiamo da tale valore il quadrato del valore atteso) per ottenere il risultato desiderato:
