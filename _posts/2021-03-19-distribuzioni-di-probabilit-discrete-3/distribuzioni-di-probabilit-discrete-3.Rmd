...
L'elenco dei valori che le due variabili aleatorie $U$ e $V$ possono assumere, insieme alla probabilità del loro verificarsi, fornisce la _distribuzione di probabilità congiunta_ delle due variabili aleatorie. 
